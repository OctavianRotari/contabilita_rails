...
(function() {
  $(function() {
    return $('#receipt_payment_date').datepicker({
      dateFormat: 'dd-mm-yy'
    });
  });
...
(function() {
  $(function() {
    return $('#insurance_date_of_issue, #insurance_deadline ').datepicker({
      dateFormat: 'dd-mm-yy'
    });
  });
...
(function() {
  $(function() {
    ...
    return $('form').on('click', '.add_vehicle_fields', function(event) {
      var id, regexp;
      id = $('.taxable').length + 1;
      regexp = new RegExp($(this).data('id'), 'g');
      $(this).before($(this).data('fields').replace(regexp, id));
...
(function() {
  jQuery(function() {
    return $('#payment_payment_date').datepicker({
      dateFormat: 'yy-mm-dd'
    });
  });
...
(function() {
  $(function() {
    return $('#ticket_date_of_issue, #ticket_deadline').datepicker({
      dateFormat: 'dd-mm-yy'
    });
  });
