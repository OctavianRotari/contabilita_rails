...
#describe CalculateTaxable do
  ...
  #describe '#total_taxable' do
    #it 'should calculate total taxable' do
      ...
      #expect(taxable.total_taxable).to equal(200.0)
    #end

    #it 'should calculate sum of two taxable' do
      #taxable = CalculateTaxable.new(invoice_params_1)
      #expect(taxable.total_taxable).to equal(1200.0)
    #end

    #it 'should calculate sum of three taxable' do
      #taxable = CalculateTaxable.new(invoice_params_2)
      #expect(taxable.total_taxable).to equal(3100.0)
    #end
  #end
#end
