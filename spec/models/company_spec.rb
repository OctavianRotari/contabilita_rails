...
describe Company, type: :unit do
  ...
  describe 'company should not be created ' do
    it 'if fields are empty' do
      ...
      company.save
      errors_should_apear = {:name=>["Inserire nome dell'azienda"], :number=>["Inserire numero telefonico dell'azienda"], :adress=>["Inserire indirizzo dell'azienda"], :category_of_company_id=>["Inserire categoria dell'azienda"]}
    ...
    it 'if company already exists' do
      create_category_of_company
      company("Bezzi")
      company = Company.new(name:"Bezzi",adress:"via felice",number:"231", category_of_company_id: 1)
      company.save
